...
function aipAPI() {
	...
	if(aiptag.settings.iVideoAdUnitBidders) {
		...
		this.adUnits['kahoot-rocks_300x250'] = [{
		code: 'kahoot-rocks_300x250',
		mediaTypes: {
			banner: {
				sizes: [300, 250]
			}
	...
	this.adSlots['kahoot-rocks_300x250'] = {adunit: 'kahoot.rocks_300x250', sizes: [300, 250], reload: true};
		this.requestManager['kahoot-rocks_300x250'] = {adserverRequestSent: false, aps: false, prebid: false};

		this.adUnits['kahoot-rocks_728x90'] = [{
		code: 'kahoot-rocks_728x90',
		mediaTypes: {
			banner: {
				sizes: [728, 90]
			}
	...
	this.adSlots['kahoot-rocks_728x90'] = {adunit: 'kahoot.rocks_728x90', sizes: [728, 90], reload: true};
		this.requestManager['kahoot-rocks_728x90'] = {adserverRequestSent: false, aps: false, prebid: false};
